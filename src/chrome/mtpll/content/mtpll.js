...
var templateBundle = templateBundleService.createBundle("chrome://mtpll/locale/mtpll.properties");
...
function openTemplateDialog() {
    ...
    openDialog("chrome://mtpll/content/mtpllOptions.xul", "", "chrome,modal", identity);
}
...
function PreLoadTemplate() {
    ...
    var gMsgCompose = win["gMsgCompose"];
